var CostOverrunController = function () {
    ...
    var loadData = function (isPageChanged) {
        $.ajax({
            type: "GET",
            url: "/Admin/CostOverrun/GetAllPaging",
            data: {
    ...
    var saveData = function (continueFlg) {
        if ($('#formMaintainance').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "/Admin/CostOverrun/SaveEntity",
                data: {
                    Id: id,
                    Name: name,
                    Price: price,
